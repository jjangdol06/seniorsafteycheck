...
router.post('/service', controller.service) // 1: ARS, 2: Direct (바로 전화)
router.get('/service', controller.getservice)
router.post('/disease', controller.disease) // 1: 당뇨 2: 고혈압 3: 치매 4: 청각장애 5: 시각장애 6: 거동불편
...
router.post('/senior-has-disease', controller.senior_has_disease) // 각 노인이 가지고 있는 질병들
router.get('/senior-has-disease', controller.getsenior_has_disease)
